...
from Server.RF.global_values import rf_save_dir
from Server.RF.rf_class import RFPre, DataProRF
from pylab import *
...
class HuiCe(StkData):
    ...
    def opt_pos_in(self, idx):
        ...
        self.log = self.log + 'positive input in p:%s\n' % str(self.input_p_real)
    ...
    def opt_neg_in(self, idx):
        ...
        self.status = -1
        self.p_max = self.data.loc[idx, 'close']
        self.log = self.log + 'negative input in p:%s\n' % str(self.input_p_real)
