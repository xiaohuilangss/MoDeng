...
class StockGui:
    ...
    def __init__(self):
        ...
        # 在“帮助”项下添加一个名为“关于聚宽数据的常见问题”的选项
        self.fileMenu.add_command(label="关于聚宽数据的常见问题",command =self.about)
        # 增加一条横线
        ...
        # self.helpMenu.add_command(label="关于聚宽数据的常见问题")
    ...
    def about(self):
        tkinter.messagebox.showinfo("关于聚宽数据的常见问题",'\r此系统仅适应于同花顺网上交易5.0，使用时请先登陆同花顺网上交易系统并切换到“同花顺双向委托界面”。\r 版本号：v 1.0.0 \r 作者：水域\r 发布日期：2017.01.11')
